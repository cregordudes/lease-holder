      ...
      <Box>
         ...
         {properties.length === 0 && (
            <Flex justifyContent="center" alignItems="center" flexDirection="column" marginTop="5" marginBottom="5">
               ...
               <Text>Please, select filter properties</Text>
            </Flex>
         )}
      </Box>
   )
...
export async function getServerSideProps({ query }:any) {
   ...
   const data = await fetchApi(`${baseUrl}/properties/list?locationExternalIDs=5002&purpose=${purpose}`);
